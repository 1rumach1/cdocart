...
<div class="sticky-top mb-2">
    ...
    <nav class="navbar navbar-expand-md bg-body-tertiary shadow">
        <div class="container-fluid">
            <a class="navbar-brand" href="c_home.php"><img class="ps-3" src="../pics/logo.png" alt="Logo" style="height: 40px;"><span class="d-none d-sm-inline">CDO Foodsphere E-Cart</span><span class="d-sm-none" style="font-size: 15px;">CDO Foodsphere E-Cart</span></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navItem">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item me-3">
                        <button type="button" class="btn nav-link active d-flex align-items-center" aria-current="page" data-bs-toggle="modal" data-bs-target="#modalMsg">
                            <i class="bi bi-chat-left-dots me-2 fs-5"></i>
                            <span class="">Message Admin</span>
                        </button>
                    </li>
                        <a class="nav-item me-3 text-decoration-none" href="cart.php">
                            <button type="button" class="btn nav-link active d-flex align-items-center">
                                <i class="bi bi-cart3 me-2 fs-5"></i>
                                <span class="">To Cart</span>
                            </button>
                        </a>
                    <a class="nav-item me-3 text-decoration-none" href="purchases.php">
                        <button type="button" class="btn nav-link active d-flex align-items-center">
                            <i class="bi bi-layers me-2 fs-5"></i>
                            <span class="">My Purchases</span>
                        </button>
                    </a>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="c_prof.php">My Profile</a></li>
                            <li>
