...
while ($orderrow = $orderShipList->fetch_assoc()) {
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer p-3 ">
                    <a type="button" class="btn me-5 rounded-pill bg-secondary text-light" href="orders.php?ordid=<?PHP echo $orderrow["orderid"] ?>">Print Reciept</a>
                    <b class="ms-auto me-5">TOTAL AMOUNT</b>
