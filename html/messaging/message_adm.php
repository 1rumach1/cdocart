...
<script>
    ...
    const CURRENT_USER = {
        ...
        reciever: '<?php echo addslashes($_SESSION["sent_to"]); ?>'
    };
    ...
    const messageHandler = {
        ...
        addMessage: (data) => {
            ...
            var reciever = CURRENT_USER.reciever;
            console.log("Received data:", "]" + reciever + "[");
            console.log("CURRENT_USER.username:", "]" + sender + "[");

            if (sender === reciever || data.username === CURRENT_USER.username) {
